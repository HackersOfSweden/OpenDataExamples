...
request.open('GET', 'https://helsingborg.opendatasoft.com/api/records/1.0/search/?dataset=wifi-punkter&q=&rows=10', true);
request.onload = function () {
  ...
  if (request.status >= 200 && request.status < 400) {
    data.records.forEach(record => {
      ...
      p4.textContent =  "Adress :" + record.fields.adress;
      const p5 = document.createElement('p');
      p5.textContent =  "Geo_point_2d :" + record.fields.geo_point_2d;
      const p6 = document.createElement('p');
      p6.textContent =  "Objectid :" + record.fields.objectid;
      const p7 = document.createElement('p');
      p7.textContent =  "Geometry type :" + record.geometry.type;
      const p8 = document.createElement('p');
      p8.textContent =  "Geometry coordinates :" + record.geometry.coordinates;
