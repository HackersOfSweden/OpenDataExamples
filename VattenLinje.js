...
request.open('GET', 'https://helsingborg.opendatasoft.com/api/records/1.0/search/?dataset=vatten-linje_new&q=&rows=2321', true);
request.onload = function () {
  ...
  if (request.status >= 200 && request.status < 400) {
    ...
    data.records.forEach(intoRecord => {
      ...
      p9.textContent ="geo_shape type : " + intoRecord.fields.geo_shape.type;

      const p10 = document.createElement('p');
      p10.textContent ="geo_shape coordinates : " + intoRecord.fields.geo_shape.coordinates;

      const p11 = document.createElement('p');
      p11.textContent ="geo_point_2d : " + intoRecord.fields.geo_point_2d;

      const p12 = document.createElement('p');
      p12.textContent ="underground : " + intoRecord.fields.underground;
      
      const p13 = document.createElement('p');
      p13.textContent ="gid : " + intoRecord.fields.gid;

      const p14 = document.createElement('p');
      p14.textContent ="locationmethod : "  + intoRecord.fields.locationmethod;

      const p15 = document.createElement('p');
      p15.textContent ="shape_stlength : " + intoRecord.fields.shape_stlength;
      ...
      p17.textContent ="regdate : " + intoRecord.fields.regdate
      ...
      p20.textContent ="supplier : " + intoRecord.fields.supplier

      const p21 = document.createElement('p');
      p21.textContent ="fitted : " + intoRecord.fields.fitted

      const p22 = document.createElement('p');
      p22.textContent ="commentary : " + intoRecord.fields.commentary

      const p23 = document.createElement('p');
      p23.textContent ="geometry type : " + intoRecord.geometry.type

      const p24 = document.createElement('p');
      p24.textContent ="geometry coordinates : " + intoRecord.geometry.coordinates

      const p25 = document.createElement('p');
      p25.textContent ="record_timestamp : " + intoRecord.record_timestamp
