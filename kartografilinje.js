...
request.open('GET', 'https://helsingborg.opendatasoft.com/api/records/1.0/search/?dataset=kartografi-linje-bebyggelse0&q=', true);
request.onload = function () {
  ...
  if (request.status >= 200 && request.status < 400) {
    ...
    data.records.forEach(intoRecord => {
      ...
      p5.textContent ="photogrammetric : " + intoRecord.fields.photogrammetric;
      ...
      p10.textContent ="gid : " + intoRecord.fields.gid;

      const p11 = document.createElement('p');
      p11.textContent ="purpose : " + intoRecord.fields.purpose;
      ...
      p14.textContent ="supplier : "  + intoRecord.fields.supplier;

      const p15 = document.createElement('p');
      p15.textContent ="stype : " + intoRecord.fields.stype;

      const p16 = document.createElement('p');
      p16.textContent ="shape_stlength : " + intoRecord.fields.shape_stlength;

      const p17 = document.createElement('p');
      p17.textContent ="type : " + intoRecord.geometry.type;

      const p18 = document.createElement('p');
      p18.textContent ="coordinates : " + intoRecord.geometry.coordinates;
